	...
	class Wow_Admin_Class { 
		...
		public function add_admin_page() {
			...
			if( !class_exists( 'Wow_Company' ) ) {
				add_menu_page( 'Wow Plugins', 'Wow Plugins', 'manage_options', 'wow-company', array( $this, 'admin_main_page' ), $icon );
				add_submenu_page( 'wow-company', 'About Wow Plugins', 'About', 'manage_options', 'wow-company' );
				add_submenu_page('wow-company', $this->plugin_name . ' version ' . $this->plugin_version, $this->plugin_menu, 'manage_options', $this->plugin_slug, array( $this, 'plugin_page' ) );
			}
			else {
				add_submenu_page('wow-company', $this->plugin_name . ' version ' . $this->plugin_version, $this->plugin_menu, 'manage_options', $this->plugin_slug, array( $this, 'plugin_page' ) );
			}
		...
		static function option( $arg ) {
			...
			elseif ($type == 'textarea'){
				$field = '<textarea name="param['.$name.']" id="wow_'.$id.'">'.$val.'</textarea>'.$separator;	
			}
