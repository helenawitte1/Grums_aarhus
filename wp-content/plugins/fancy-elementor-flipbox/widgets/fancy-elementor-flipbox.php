...
$tp_flipbox_show_btn = $settings['tp_flipbox_show_btn'];
	  ...
	  echo '                </div>';
	  echo '                <div class="tp-flipbox__title-front">'.$settings['tp_flipbox_f_title'].'</div>';
	  echo '                <div class="tp-flipbox__desc-front">'.$settings['tp_flipbox_f_desc'].'</div>';
	  echo '            </div>';
	  echo '        </div>';
	  ...
	  echo '                </div>';
	  echo '                <div class="tp-flipbox__title-back">'.$settings['tp_flipbox_b_title'].'</div>';
		echo '                <div class="tp-flipbox__desc-back">'.$settings['tp_flipbox_b_desc'].'</div>';
		if($tp_flipbox_show_btn == "yes"){
	  echo '               <div class="tp-flipbox__action">';
	  echo '                    <a href="'.$settings['tp_flipbox_b_btn_url']['url'].'" class="tp-flipbox__btn">'.$settings['tp_flipbox_b_btn_text'].'</a>';
	  echo '                   </div>';
	}
	  echo '                </div>';
	  echo '            </div>';
	      ...
	      <div class="tp-flipbox__holder" >
	          <div class="tp-flipbox__front">
	              ...
	              <div class="tp-flipbox__content">
	                  ...
	                  <div class="tp-flipbox__title-front">{{{ settings.tp_flipbox_f_title }}}</div>
	                  <div class="tp-flipbox__desc-front">{{{ settings.tp_flipbox_f_desc }}}</div>
	              </div>
	          </div>
	          <div class="tp-flipbox__back" >
	              ...
	              <div class="tp-flipbox__content">
	                  ...
	                  <div class="tp-flipbox__title-back">{{{ settings.tp_flipbox_b_title }}}</div>
										<div class="tp-flipbox__desc-back">{{{ settings.tp_flipbox_b_desc }}}</div>
